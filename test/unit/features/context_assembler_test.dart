...
void main() {
  ...
  test('includes prior turns in order, including a stopped-partial turn (FR-017)', () {
    final messages = [
      ...
      msg(4, MessageRole.assistant, 'about two', status: MessageStatus.stoppedPartial),
    ];
    ...
    expect(context, const [
      ...
      ChatTurn(isUser: false, text: 'about two'), // stopped-partial is included
    ]);
  });
  ...
  test('on overflow, drops the OLDEST turns only; stored history is untouched (Q2)', () {
