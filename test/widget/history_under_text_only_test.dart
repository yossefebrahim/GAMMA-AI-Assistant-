...
void main() {
  testWidgets('a persisted image message still renders under a text-only model (FR-017)',
      (tester) async {
    final message = Message(
      ...
      image: const ImageAttachment(path: '/tmp/persisted.jpg', mimeType: 'image/jpeg'),
    );
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          ...
          modelCapabilitiesProvider.overrideWith((ref) => const ModelCapabilities(image: false)),
        ],
        child: MaterialApp(
