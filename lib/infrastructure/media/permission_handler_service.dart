...
/// `lib/infrastructure/media/` (enforced by tool/check_plugin_seam.sh), so the attachment
/// controller tests with `FakeMediaPermissionService` (002 R3). Only the **camera** permission is
/// modeled; the photo library is permissionless on modern Android (the Photo Picker).
